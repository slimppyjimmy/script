...
DROP TABLE IF EXISTS DCC_TASK_LOG;
DROP TABLE IF EXISTS DCC_TASK_LOG_DETAIL;
...
(	ID int(10) NOT NULL AUTO_INCREMENT,
   ...
   AGENTENDTIME  datetime,
   AGENTGUID varchar(38),
   AGENTSTARTTIME datetime,
   MANAGEREALMGUID varchar(38),
   OPERATIONMASKS int(19),
   PERMISSIONTYPE int(10),
   PRIORITY int(10),
...
(	ID int(10) NOT NULL AUTO_INCREMENT,
   ...
   ELAPSEDTIME int(10) NOT NULL DEFAULT 0,
...
ALTER TABLE DCC_DICTIONARY MODIFY COLUMN DICTIONARYTYPE varchar(8) COMMENT '数据字典类型';
ALTER TABLE DCC_DICTIONARY MODIFY COLUMN MARK varchar(255) COMMENT '字典项代码';
ALTER TABLE DCC_DICTIONARY MODIFY COLUMN K_NAME varchar(190) COMMENT '名字，或者实际意义项';

--  DDL for Table DCC_DICTIONARY_TYPE
CREATE TABLE DCC_DICTIONARY_TYPE
(	ID int(11) AUTO_INCREMENT,
   K_NAME varchar(190),
   K_TYPE varchar(8) NOT NULL UNIQUE,
   PRIMARY KEY (ID) USING BTREE
) ;

ALTER TABLE DCC_DICTIONARY_TYPE MODIFY COLUMN K_NAME varchar(190) COMMENT '描述数据字典类型表中类型的名称';
ALTER TABLE DCC_DICTIONARY_TYPE MODIFY COLUMN K_TYPE varchar(8) COMMENT '数据字典类型代码';
...
(	ID int(11) NOT NULL AUTO_INCREMENT,
   ...
   STRVALUE varchar(50) DEFAULT NULL,
   NUMBERVALUE int(8) DEFAULT NULL,
   DATEVALUE datetime DEFAULT NULL,
   CLOBVALUE text DEFAULT NULL,
   BOOLEANVALUE int(1) DEFAULT NULL,
   PRIMARY KEY (ID) USING BTREE
) ;

ALTER TABLE DCC_EXTENDED_INFO COMMENT '扩展信息表';
...
(	ID int(10) NOT NULL AUTO_INCREMENT,
   ...
   RESOURCETYPE int(10),
   SORTNO int(10) NOT NULL,
   TREECODE varchar(190) UNIQUE,
   URL varchar(255),
   MUTEXTYPE int(10) NOT NULL DEFAULT 0,
   NEEDLOG int(1) NOT NULL DEFAULT 0,
   READONLY int(10) DEFAULT 1,
   PRIMARY KEY (ID) USING BTREE
) ;
...
(	ID int(10) NOT NULL AUTO_INCREMENT,
   ...
   K_MAXVALUE float(126,0),
   K_NAME varchar(190),
   SERVERGUID varchar(38),
   K_TYPE int(10) NOT NULL,
   HANDLEDATE DATE DEFAULT NULL,
	 HANDLELEVEL int(10) DEFAULT NULL,
   PRIMARY KEY (ID) USING BTREE
) ;
...
ALTER TABLE DCC_LOGIN_USER COMMENT '已登录用户';
...
(	ID int(10) NOT NULL AUTO_INCREMENT,
   GUID varchar(38) NOT NULL UNIQUE UNIQUE,
   USERGUID varchar(38),
...
(	ID int(10) NOT NULL AUTO_INCREMENT,
   ...
   TREECODE varchar(190) NOT NULL UNIQUE,
   PRIMARY KEY (ID) USING BTREE
) ;
...
(	ID int(11) NOT NULL AUTO_INCREMENT,
   ...
   SORTNO int(8) NOT NULL DEFAULT 9999,
   PRIMARY KEY (ID) USING BTREE
) ;

ALTER TABLE DCC_ORG_ROLE COMMENT '岗位角色和机构之间的关系';
...
(	ID int(10) NOT NULL AUTO_INCREMENT,
   ...
   K_NAME varchar(190),
   K_TYPE int(10),
   SORTNO int(11) NOT NULL DEFAULT 9999,
   PRIMARY KEY (ID) USING BTREE
) ;
...
(	ID int(10) NOT NULL AUTO_INCREMENT,
   GUID varchar(38) NOT NULL UNIQUE,
   ERRORLOGS varchar(255) charset utf8 collate utf8_general_ci,
...
(	ID int(10) NOT NULL AUTO_INCREMENT,
   ...
   REMARK varchar(255),
   SORTNO int(10),
   SYNCCONFLITSTRATEGY int(10),
   SYNCDIRECTION int(10),
...
(	ID int(10) NOT NULL AUTO_INCREMENT,
   ...
   APP_ID varchar(38),
   APP_NAME varchar(40),
   DB_ADD_FAIL_COUNT int(10),
   DB_ADD_SUCCESS_COUNT int(10),
   DB_ADD_COUNT int(10),
   DB_CHECK_FAIL_COUNT int(10),
   DB_DELETE_FAIL_COUNT int(10),
   DB_DELETE_SUCCESS_COUNT int(10),
   DB_DELETE_COUNT int(10),
   DB_MODIFY_FAIL_COUNT int(10),
   DB_MODIFY_SUCCESS_COUNT int(10),
   DB_MODIFY_COUNT int(10),
   ELAPSED_TIME int(19),
   END_TIME datetime,
   LDAP_ADD_FAIL_COUNT int(10),
   LDAP_ADD_SUCCESS_COUNT int(10),
   LDAP_ADD_COUNT int(10),
   LDAP_CHECK_FAIL_COUNT int(10),
   LDAP_DELETE_FAIL_COUNT int(10),
   LDAP_DELETE_SUCCESS_COUNT int(10),
   LDAP_DELETE_COUNT int(10),
   LDAP_MODIFY_FAIL_COUNT int(10),
   LDAP_MODIFY_SUCCESS_COUNT int(10),
   LDAP_MODIFY_COUNT int(10),
   START_TIME datetime,
   STATUS int(10),
...
(	ID int(10) NOT NULL AUTO_INCREMENT,
   ...
   LOGINFAILCOUNT int(10) NOT NULL DEFAULT 0,
   ISINSTAFF int(1) NOT NULL DEFAULT 0,
   JOBNUMBER varchar(38),
   K_LEVEL varchar(8) NOT NULL DEFAULT '8',
   PRIMARY KEY (ID) USING BTREE
) ;
...
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1562,'677F965D297646998C0D334B0808EF8C','sql脚本内置插入语句','patch_2018_09_26_01_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1403,'22F81138624C438DA7F858D6F09425FD','sql脚本内置插入语句','patch_2018_07_08_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1407,'8B5B7DB0CEFF45E28B1F413E66F6A088','sql脚本内置插入语句','patch_2018_07_18_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1380,'1D6DB3F2DAB74F399E169F376AE2D4A6','sql脚本内置插入语句','patch_2018_05_24_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1040,'8F50F31584774E358F984351F348C2FC','sql脚本内置插入语句','patch_2017_07_15_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1041,'40BDB376F80F412BB5757CAF3E3567DF','sql脚本内置插入语句','patch_2017_07_21_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1048,'CF0A532FBB004F69BEB0F407F6A762E6','sql脚本内置插入语句','patch_2017_07_26_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1089,'82EB8600A57D4892BB59D0CFF64A6385','sql脚本内置插入语句','patch_2017_07_27_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1091,'EF703FACB98545B68360DC8C07F65413','sql脚本内置插入语句','patch_2017_07_28_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1096,'625F9A14B6E74C63B4E858A8420ADD17','sql脚本内置插入语句','patch_2017_07_30_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1097,'104FCA75B3844CCCB1DC66CEB4ECC3FB','sql脚本内置插入语句','patch_2017_08_01_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1100,'614C9BBFD9904A8187B092FCD6E94813','sql脚本内置插入语句','patch_2017_08_02_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1105,'B9C431E5D4C64A83BFD1B10F50CD7186','sql脚本内置插入语句','patch_2017_08_04_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1106,'31734A15E53D4183A83CF4AE6E9DC90B','sql脚本内置插入语句','patch_2017_08_05_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1107,'FE9E3985EF464F7DBF37840862D12B88','sql脚本内置插入语句','patch_2017_08_09_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1110,'D554CAC65D0B4A64A760619D41645BDE','sql脚本内置插入语句','patch_2017_08_10_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1111,'EBB96452D38E46DD86BF40AFE3668D93','sql脚本内置插入语句','patch_2017_08_18_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1116,'D49A762029EA43ECBA09EF330D2140B4','sql脚本内置插入语句','patch_2017_08_21_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1119,'F43B30B8E2D94C9F86E4BB3229976F7B','sql脚本内置插入语句','patch_2017_08_23_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1255,'CFC4DC5EFEB34134852F6741E5008A6F','sql脚本内置插入语句','patch_2017_10_10_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1256,'330B21B7AC454EC9B726FA148459B7F8','sql脚本内置插入语句','patch_2017_10_15_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1257,'37CD1931E91444D4AA11AB62BEA8EE34','sql脚本内置插入语句','patch_2017_10_25_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1258,'5E43E32FA8A7496ABE17405B2FAEF4D3','sql脚本内置插入语句','patch_2017_10_27_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1273,'A2F20DC34A6D4A2B98C7EE20BDCF303A','sql脚本内置插入语句','patch_2017_11_01_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1301,'82B8282F496F480499692F90DA2BC9C9','sql脚本内置插入语句','patch_2017_11_08_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1302,'ACC93C26896247CFBCD9AA52EC6233BA','sql脚本内置插入语句','patch_2017_11_09_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1303,'4E39513EC81D49F293A8EBF801253A4A','sql脚本内置插入语句','patch_2017_11_14_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1318,'84562FC3C74C492AADB200620201BE31','sql脚本内置插入语句','patch_2017_11_19_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1319,'5502D711027F448695CE316010C45F2C','sql脚本内置插入语句','patch_2017_12_06_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (-1,'25a068f7-ec18-49e9-ae53-1a86d14215aa',null,'patch_2017_06_12_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (-2,'1fe9aabc-88f7-4549-9142-9bf29cbeb98f',null,'patch_2017_06_14_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (-3,'4c3b0abe-4f67-44e8-a7ef-a04c1f5533a1',null,'patch_2017_06_15_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (-4,'b1b4bfbf-0589-449a-b5bb-c006841188f0',null,'patch_2017_06_19_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1120,'4D0EC2C665F241228774E7445F83C68E','sql脚本内置插入语句','patch_2017_09_07_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1251,'717943A76D5143BA91FFD3174132EC85','sql脚本内置插入语句','patch_2017_09_12_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1252,'3226BA90A2DE4BFEBEB27F7029020360','sql脚本内置插入语句','patch_2017_09_22_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1253,'8BB2088D41424E62A75E02E0395673C3','sql脚本内置插入语句','patch_2017_09_27_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1254,'1C2C6034638A4DB3B0D08E72B60682C4','sql脚本内置插入语句','patch_2017_09_30_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1341,'3C02F9F363CC493E9EA6A5AC189F478A','sql脚本内置插入语句','patch_2017_12_21_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1363,'32C113022DEF4BF08C062B2EF3E55E3E','sql脚本内置插入语句','patch_2017_12_25_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1370,'2F6FDD0E4F6C4E348DE20396276CCD8F','sql脚本内置插入语句','patch_2018_01_05_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1374,'A6370FBBD01C41BB9A9BDEE3DA4519D2','sql脚本内置插入语句','patch_2018_03_08_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1378,'DAA489795270418C958AB14C972FBDF7','sql脚本内置插入语句','patch_2018_04_27_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1554,'01CD7931A4354AA6B2FB815088667877','sql脚本内置插入语句','patch_2018_08_30_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1576,'802CAABCB5F54B6D93BA86C4D5512E33','sql脚本内置插入语句','patch_2018_09_26_02_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1639,'AB814A68858844749DE0C54776C37A56','sql脚本内置插入语句','patch_2018_09_26_03_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1642,'AFE714F572C643B69C005AD62216100B','sql脚本内置插入语句','patch_2018_11_27_01_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1670,'FFF8CB8EC4594F1E95EDB0F2743D0BA9','sql脚本内置插入语句','patch_2018_11_27_02_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1777,'E939459317434E5DA5064503CA48450C','sql脚本内置插入语句','patch_2018_11_27_03_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1611, '18bc997b-3854-11e9-a2b7-0242ac110007','sql脚本内置插入语句','patch_2018_12_06_01_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1612, '18c6056c-3854-11e9-a2b7-0242ac110007','sql脚本内置插入语句','patch_2018_12_29_01_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1613, '18d06f21-3854-11e9-a2b7-0242ac110007','sql脚本内置插入语句','patch_2018_09_26_03_mysql.sql');
Insert into DCC_SQL_SCRIPT_EXE_LOG (ID,GUID,ERRORLOGS,FILENAME) values (1614, '18d8ded2-3854-11e9-a2b7-0242ac110007','sql脚本内置插入语句','patch_2018_11_27_03_mysql.sql');

Insert into DCC_USER (ID,GUID,CREATEDATE,EMAIL,ICONURL,LASTONLINEDATE,LOGINNAME,LOGINPWD,MOBILEPHONE,POSTCODE,PY,REALMGUID,REMARK,SIGNPWD,SORTNO,STATE,TELEPHONE,USERNAME,USERTYPE,ISLOCKED,LOGINFAILCOUNT,ISINSTAFF,JOBNUMBER,K_LEVEL) values (1320,'85A2EE39-A64A-40AD-B9B1-A2389AA6A1AD','2017-12-14 10:55:30',null,null,null,'admin-c','nWdsNc8K0PmetFxQvBzrmQ==',null,null,null,null,null,'nWdsNc8K0PmetFxQvBzrmQ==',1,1,null,'全局配置管理员',1,0,0,0,null,'8');
Insert into DCC_USER (ID,GUID,CREATEDATE,EMAIL,ICONURL,LASTONLINEDATE,LOGINNAME,LOGINPWD,MOBILEPHONE,POSTCODE,PY,REALMGUID,REMARK,SIGNPWD,SORTNO,STATE,TELEPHONE,USERNAME,USERTYPE,ISLOCKED,LOGINFAILCOUNT,ISINSTAFF,JOBNUMBER,K_LEVEL) values (1321,'67C42486-97B0-4112-8D92-A39C6C683D54','2017-12-14 10:55:30',null,null,null,'admin-s','nWdsNc8K0PmetFxQvBzrmQ==',null,null,null,null,null,'nWdsNc8K0PmetFxQvBzrmQ==',1,1,null,'全局安全管理员',1,0,0,0,null,'8');
Insert into DCC_USER (ID,GUID,CREATEDATE,EMAIL,ICONURL,LASTONLINEDATE,LOGINNAME,LOGINPWD,MOBILEPHONE,POSTCODE,PY,REALMGUID,REMARK,SIGNPWD,SORTNO,STATE,TELEPHONE,USERNAME,USERTYPE,ISLOCKED,LOGINFAILCOUNT,ISINSTAFF,JOBNUMBER,K_LEVEL) values (1322,'057293DA-90DA-4CCC-A253-BDFE61CD4DDD','2017-12-14 10:55:30',null,null,null,'admin-a','nWdsNc8K0PmetFxQvBzrmQ==',null,null,null,null,null,'nWdsNc8K0PmetFxQvBzrmQ==',1,1,null,'全局审计管理员',1,0,0,0,null,'8');
...
ALTER TABLE DCC_CONFIG_VALUE ADD UNIQUE UK_JWJNW79FKFJ6ER7OXYFBPW0X0 (GUID)
;

--  DDL for Index DCC_REALM_INDEX_K_NAME_INDEX
ALTER TABLE DCC_REALM ADD UNIQUE DCC_REALM_INDEX_K_NAME_INDEX (K_NAME)
;
...
ALTER TABLE DCC_DICTIONARY ADD INDEX IXFK_DCC_DICTIONA_DCC_DIC01 (DICTIONARYTYPE  )
;

--  DDL for Index QRTZ_FIRED_TRIGGER_PK
ALTER TABLE QRTZ_FIRED_TRIGGERS ADD UNIQUE QRTZ_FIRED_TRIGGER_PK (SCHED_NAME, ENTRY_ID )
;

--  DDL for Index QRTZ_PAUSED_TRIG_GRPS_PK
ALTER TABLE QRTZ_PAUSED_TRIGGER_GRPS ADD UNIQUE QRTZ_PAUSED_TRIG_GRPS_PK (SCHED_NAME, TRIGGER_GROUP )
;
...
ALTER TABLE QRTZ_FIRED_TRIGGERS ADD INDEX IDX_QRTZ_FT_TG (SCHED_NAME, TRIGGER_GROUP)
;

--  DDL for Index UK_6Q70FKVCW7WB3JBOSCXPHN654
ALTER TABLE DCC_HEALTH_DEVICE ADD UNIQUE UK_6Q70FKVCW7WB3JBOSCXPHN654 (GUID)
;
...
ALTER TABLE DCC_LOGIN_USER ADD INDEX DCC_LOGIN_USER_INDEX_LOGINTIME (LOGINTIME DESC)
;

--  DDL for Index UK_694UE95UUU3YR1DYQSKCDXSYX
ALTER TABLE DCC_AUDIT_LOG ADD UNIQUE UK_694UE95UUU3YR1DYQSKCDXSYX (GUID)
;
...
ALTER TABLE DCC_ROLE ADD INDEX INDEX_ROLE_TYPE (ROLETYPE  )
;

--  DDL for Index QRTZ_CRON_TRIG_PK
ALTER TABLE QRTZ_CRON_TRIGGERS ADD UNIQUE QRTZ_CRON_TRIG_PK (SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP)
;

--  DDL for Index IXFK_DCC_APP_HEALTH_APPGUID
ALTER TABLE DCC_APP_HEALTH_CONFIG ADD INDEX IXFK_DCC_APP_HEALTH_APPGUID (APPGUID)
;

--  DDL for Index INDEX_ROLEMEMBER_ROLE_MEMBER
ALTER TABLE DCC_ROLE_MEMBER ADD INDEX INDEX_ROLEMEMBER_ROLE_MEMBER (ROLEGUID, MEMBERGUID)
;

--  DDL for Index UK_NUV28ADC067UXKJ3Y8IHJAU0R
ALTER TABLE DCC_HEALTH_SERVER ADD UNIQUE UK_NUV28ADC067UXKJ3Y8IHJAU0R (GUID)
;

--  DDL for Index UK_RBNS89FR5MS76T4DJ4VTYDX7U
ALTER TABLE DCC_OPERATION ADD UNIQUE UK_RBNS89FR5MS76T4DJ4VTYDX7U(GUID)
;

--  DDL for Index PK_APPHEALTH_GUID
ALTER TABLE DCC_APP_HEALTH_CONFIG ADD UNIQUE PK_APPHEALTH_GUID (GUID)
;

--  DDL for Index UK_446GBY2XPQR22LVPPN2BG0FU3
ALTER TABLE DCC_ROLE_MEMBER ADD UNIQUE UK_446GBY2XPQR22LVPPN2BG0FU3 (GUID)
;

--  DDL for Index DCC_LOGIN_USER_KEY_ID
ALTER TABLE DCC_LOGIN_USER ADD UNIQUE DCC_LOGIN_USER_KEY_ID (ID)
;

--  DDL for Index UK_7S1F3F3L0CHRBXWNYOM4BE6CL
ALTER TABLE DCC_TASK_LOG ADD UNIQUE UK_7S1F3F3L0CHRBXWNYOM4BE6CL (GUID)
;
...
ALTER TABLE DCC_REALM_MANAGER ADD UNIQUE UK_919AQ99OCCUVIHQ2RS7A4VSPK (GUID)
;

--  DDL for Index QRTZ_SIMPLE_TRIG_PK
ALTER TABLE QRTZ_SIMPLE_TRIGGERS ADD UNIQUE QRTZ_SIMPLE_TRIG_PK (SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP)
;

--  DDL for Index QRTZ_SCHEDULER_STATE_PK
ALTER TABLE QRTZ_SCHEDULER_STATE ADD UNIQUE QRTZ_SCHEDULER_STATE_PK (SCHED_NAME, INSTANCE_NAME )
;
...
ALTER TABLE DCC_TASK_LOG_DETAIL ADD UNIQUE UK_O6SQCJ3FJGG0K9AQNB61QK2CL (GUID)
;

--  DDL for Index DCC_TASK_INDEX_K_NAME_INDEX
ALTER TABLE DCC_TASK ADD UNIQUE DCC_TASK_INDEX_K_NAME_INDEX (K_NAME)
;

--  DDL for Index QRTZ_BLOB_TRIG_PK
ALTER TABLE QRTZ_BLOB_TRIGGERS ADD UNIQUE QRTZ_BLOB_TRIG_PK (SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP)
;

--  DDL for Index UK_L1CVJ1UPRM86OGATRR9MJNPS3
ALTER TABLE DCC_ROLE ADD UNIQUE UK_L1CVJ1UPRM86OGATRR9MJNPS3 (GUID)
;

--  DDL for Index QRTZ_SIMPROP_TRIG_PK
ALTER TABLE QRTZ_SIMPROP_TRIGGERS ADD UNIQUE QRTZ_SIMPROP_TRIG_PK (SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP)
;
...
ALTER TABLE DCC_APP ADD UNIQUE UK_G44WKIQSWBBMXIA4739JHQCWV (GUID)
;

--  DDL for Index INDEX_ROLEMEMBER_MEMBER_ROLE
ALTER TABLE DCC_ROLE_MEMBER ADD INDEX INDEX_ROLEMEMBER_MEMBER_ROLE (MEMBERGUID, ROLEGUID)
;

--  DDL for Index UK_QYLDT9JFQF5JL52RNYB8A41FK
ALTER TABLE DCC_JOB ADD UNIQUE UK_QYLDT9JFQF5JL52RNYB8A41FK (GUID)
;

--  DDL for Index INDEX_ROLEMEMBER_MEMBER
ALTER TABLE DCC_ROLE_MEMBER ADD INDEX INDEX_ROLEMEMBER_MEMBER (MEMBERGUID)
;

--  DDL for Index QRTZ_JOB_DETAILS_PK
ALTER TABLE QRTZ_JOB_DETAILS ADD UNIQUE QRTZ_JOB_DETAILS_PK (SCHED_NAME, JOB_NAME, JOB_GROUP)
;

--  DDL for Index UK_64O23N9DIUSYWKWIKTO2T9ANY
ALTER TABLE DCC_FUNCTION ADD UNIQUE UK_64O23N9DIUSYWKWIKTO2T9ANY (GUID)
;
...
ALTER TABLE DCC_USER_AGENT ADD UNIQUE UK_AGENT (GUID)
;
...
ALTER TABLE DCC_REALM_ORG ADD UNIQUE UK_SOH9GXTO6RRX89Y1BEJ4OOEEN (GUID)
;

--  DDL for Index QRTZ_LOCKS_PK
ALTER TABLE QRTZ_LOCKS ADD UNIQUE QRTZ_LOCKS_PK (SCHED_NAME, LOCK_NAME)
;

--  DDL for Index UK_97W043GTKDEXDWI22CWK4YSF4
ALTER TABLE DCC_ACE ADD UNIQUE UK_97W043GTKDEXDWI22CWK4YSF4 (GUID)
;
...
ALTER TABLE DCC_EXTENDED_INFO ADD UNIQUE PK_EXTENDEDINFO (ID)
;
...
ALTER TABLE DCC_ORG ADD UNIQUE UK_TGC1MNEOU9AU9KWQBKYKLAO8W (GUID)
;

--  DDL for Index UK_RSROKQ66IFKF0E3GMKL0SBMBN
ALTER TABLE DCC_CONFIG_DEFINITION ADD UNIQUE UK_RSROKQ66IFKF0E3GMKL0SBMBN (GUID)
;

--  DDL for Index DCC_JOB_INDEX_K_NAME_UINDEX
ALTER TABLE DCC_JOB ADD UNIQUE DCC_JOB_INDEX_K_NAME_UINDEX (K_NAME)
;

--  DDL for Index QRTZ_CALENDARS_PK
ALTER TABLE QRTZ_CALENDARS ADD UNIQUE QRTZ_CALENDARS_PK (SCHED_NAME, CALENDAR_NAME)
;

--  DDL for Index DCC_NOTICE_USER_GUID_UINDEX
ALTER TABLE DCC_NOTICE_USER ADD UNIQUE DCC_NOTICE_USER_GUID_UINDEX (GUID)
;

--  DDL for Index INDEX_ROLEMEMBER_ROLE
ALTER TABLE DCC_ROLE_MEMBER ADD INDEX INDEX_ROLEMEMBER_ROLE (ROLEGUID)
;

--  DDL for Index QRTZ_TRIGGERS_PK
ALTER TABLE QRTZ_TRIGGERS ADD UNIQUE QRTZ_TRIGGERS_PK (SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP)
;

--  DDL for Index UK_7V69L5U5FJFB5IOXKV3MBI2GR
ALTER TABLE DCC_PWD_HISTORY ADD UNIQUE UK_7V69L5U5FJFB5IOXKV3MBI2GR (GUID)
;
...
ALTER TABLE DCC_AUDIT_EVENT ADD UNIQUE UK_5DW40D6GYRN84RXNCJEIROLRM (GUID)
;

--  DDL for Index UK_R7DIX707RL4I5XHY0HE2JH8QR
ALTER TABLE DCC_SQL_SCRIPT_EXE_LOG ADD UNIQUE UK_R7DIX707RL4I5XHY0HE2JH8QR (GUID)
;

--  DDL for Index DCC_APP_INDEX_K_NAME_UINDEX
ALTER TABLE DCC_APP ADD UNIQUE DCC_APP_INDEX_K_NAME_UINDEX (K_NAME)
;

--  DDL for Index UK_3AOY15UXGQB39A3CJB8C53G9D
ALTER TABLE DCC_CONFIG_DEFINITION_OPTION ADD UNIQUE UK_3AOY15UXGQB39A3CJB8C53G9D (GUID)
;

--  DDL for Index UK_AXTL4PUW0V4MKDIW8U6KD7VXX
ALTER TABLE DCC_REALM ADD UNIQUE UK_AXTL4PUW0V4MKDIW8U6KD7VXX (GUID  )
;

ALTER TABLE DCC_AUDIT_STATISTICS ADD INDEX DCC_AUDIT_STATISTICS_INDEX (BEGINDATE, ENDDATE, PERIOD)
;
...
ALTER TABLE DCC_STATION ADD UNIQUE UK_CNO41TJJ22LHGTH37YVNDWWW8 (GUID)
;

--  DDL for Index UK_486A6G0GGW3IQEMD76XPTL1XH
ALTER TABLE DCC_APP_MANAGER ADD UNIQUE UK_486A6G0GGW3IQEMD76XPTL1XH (GUID)
;

--  DDL for Index UK_OD7LX47CCDNPQ85G963BMW7HJ
ALTER TABLE DCC_USER ADD UNIQUE UK_OD7LX47CCDNPQ85G963BMW7HJ (GUID)
;

--  DDL for Index UK_QKL14C2HKNUG9TX0HHORHDIXH
ALTER TABLE DCC_HEALTH_DEVICE_STATUS ADD UNIQUE UK_QKL14C2HKNUG9TX0HHORHDIXH (GUID)
;

--  DDL for Index PK_APPHEALTH_INDEXKEY
ALTER TABLE DCC_APP_HEALTH_CONFIG ADD UNIQUE PK_APPHEALTH_INDEXKEY (ID)
;

--  DDL for Index UK_DDVOTMBV0IB34AIBV1BPASAE
ALTER TABLE DCC_SYNC_APP ADD UNIQUE UK_DDVOTMBV0IB34AIBV1BPASAE (GUID)
;

--  DDL for Index SYS_C0035244
ALTER TABLE DCC_NOTICE ADD UNIQUE SYS_C0035244 (GUID)
;
...
ALTER TABLE DCC_TASK ADD UNIQUE UK_6R3XPQEOYG5UE3QWDSEFB0DCI (GUID)
;
...
ALTER TABLE DCC_FIELD_VALIDATE_DEFINITION ADD UNIQUE UK_WLLBVIMDT1QNL5YFUTOGH12N (GUID)
;

--  DDL for Index UK_4IYRE0DWAW4B405Q87DRYF575
ALTER TABLE DCC_AUDIT_STATISTICS ADD UNIQUE UK_4IYRE0DWAW4B405Q87DRYF575 (GUID)
;

--  DDL for Index UNIQUE_KEY_GUID
ALTER TABLE DCC_EXTENDED_INFO ADD UNIQUE UNIQUE_KEY_GUID (GUID)
;
